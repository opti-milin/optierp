...
ENTITIES: tuple[EntitySpec, ...] = (
    ...
    EntitySpec(
        ...
        target="Currency", module="Core", stage=STAGE_TREE,
        notes="Matched on ISO code; unknown symbols are reported, not invented.",
    ),
    EntitySpec(
    ...
    EntitySpec(
        ...
        notes="Tally allows a second, orthogonal cost dimension. OptiERP has a "
              "single Cost Center tree, so categories are kept on the staging "
              "row for reference and folded into the cost centre name.",
    ),
    EntitySpec(
